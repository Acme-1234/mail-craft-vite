...
const EmailEditor = React.forwardRef<EmailEditorRef, EmailEditorProps>(  ({ placeholders, onImageSelect, initialDocument }, ref) => {    const {
    ...
    } = useEditorStore();    // Debug logging - only run once on mount
    useEffect(() => {
    ...
    }, [onImageSelect, setOnImageSelect]);    useEffect(() => {
      if (initialDocument) {
            ...
            <header className="p-4 border-b border-border flex justify-between items-center">
              <h1 className="text-2xl font-headline text-primary">Mailcraft</h1>              <div className="flex gap-2">
                ...
                <Button variant="destructive" size="sm" onClick={handleClearDocument}>
                 ...
                 <Button variant="outline" size="sm" onClick={() => console.log(extractLinksFromDocument(document))}>
